 ...
 * Purpose: RightRotateCommand is a TurtleOperation and a Command that can execute to change the heading of the assigned
 ...
 * Dependencies: Animal
 * How to use: Instantiate RightRotateCommand, assign desired Animal, call evaluate() if it is an argument of another Operation. If
